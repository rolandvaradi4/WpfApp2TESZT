...
namespace WpfApp2.Models
{
    ...
    new Point(0, 0),
            ...
            BitmapImage back = new BitmapImage(new Uri("pack://application:,,,/Models/skyboxBottom.png", UriKind.RelativeOrAbsolute));
            ...
            meshGeometry3DFront.Positions = new Point3DCollection(new Point3D[]
           {
            ...
            BitmapImage Front = new BitmapImage(new Uri("pack://application:,,,/Models/skyboxTop.png", UriKind.RelativeOrAbsolute));
    ...
    new Point(1, 1),
            ...
            BitmapImage Right = new BitmapImage(new Uri("pack://application:,,,/Models/skyboxFront.png", UriKind.RelativeOrAbsolute));
    ...
    new Point(0, 0),
            ...
            BitmapImage Top = new BitmapImage(new Uri("pack://application:,,,/Models/skyboxRight.png", UriKind.RelativeOrAbsolute));
...
new Point(1, 1),
    ...
    new Point(0, 0),
            ...
            BitmapImage Bottom = new BitmapImage(new Uri("pack://application:,,,/Models/skyboxBack.png", UriKind.RelativeOrAbsolute));
